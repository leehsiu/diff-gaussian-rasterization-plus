...
#
# This file is further edited by lixiu.cv@bytedance.com to support optimal/
...
def rasterize_gaussians_surface(
        raster_settings, means3D, means2D, opacities, shs=None, colors_precomp=None, scales=None, rotations=None, cov3D_precomp=None):
